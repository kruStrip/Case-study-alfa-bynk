...
interface SelfSavingsHistoryPageProps {
  onBack: () => void;
}

/**
 * Компонент страницы для отображения истории личных отложений.
 * @param onBack Функция для возврата на предыдущий экран.
 */
export function SelfSavingsHistoryPage({ onBack }: SelfSavingsHistoryPageProps) {
  return (
    <div className="h-screen bg-white flex flex-col">
      ...
      <div className="sticky top-0 bg-white border-b border-gray-200 z-10 px-4 py-3 flex items-center">
        ...
        <h1 className="text-xl font-semibold text-gray-900 ml-2">История личных отложений</h1>
      </div>

      {/* Content */}
      <div className="flex-1 p-4 overflow-y-auto">
        <p className="text-gray-700">Здесь будет отображаться детальная история ваших личных отложений.</p>
        {/* Здесь можно добавить логику для загрузки и отображения реальных данных */}
        <div className="mt-4 space-y-3">
          {/* Пример элемента истории */}
          <div className="bg-gray-100 rounded-xl p-4">
            <div className="flex justify-between items-center">
              <p className="font-medium">Перевод с карты</p>
          ...
          <div className="bg-gray-100 rounded-xl p-4">
            <div className="flex justify-between items-center">
              <p className="font-medium">Зачисление зарплаты</p>
          ...
          <div className="bg-gray-100 rounded-xl p-4">
            <div className="flex justify-between items-center">
              <p className="font-medium">Перевод с другого счета</p>
